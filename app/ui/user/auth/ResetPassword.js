...
import { getUser, resetUserPassword } from "@/app/actions/userAuth";
...
export default function ResetPassword() {
    const [state, loginAction] = useFormState(resetUserPassword, null);
    ...
    useEffect(() => {
        ...
        getUser("", searchParams.get("user")).then((res) => {
            if (res?.status === 200) {
            ...
            <div className="min-h-screen">
                ...
                <div className="flex flex-col min-h-full justify-center px-6 py-12 lg:px-8">
                    <div className="sm:mx-auto sm:w-full sm:max-w-sm flex flex-col items-center justify-center">
                        ...
                        />
                        <h2 className="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Reset your password <br />
                            <i>
                                {
                                    " " + username
                                }
                    ...
                    <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                        <form action={loginAction} className="space-y-6" id="passwordRestTokenForm">
                            <div>
                                <label htmlFor="password" className="block text-sm font-medium leading-6 text-gray-900">Enter your New Password</label>
                                <div className="mt-2">
                                    <input
                                        id="password"
                                        name="password"
                            ...
                            <div>
                                <label htmlFor="cpassword" className="block text-sm font-medium leading-6 text-gray-900">Confirm your New Password</label>
                                <div className="mt-2">
                                    <input
                                        id="cpassword"
                                        name="cpassword"
                            ...
                            <input type="hidden" name="userID" value={searchParams.get("user")} />
                            <div>
